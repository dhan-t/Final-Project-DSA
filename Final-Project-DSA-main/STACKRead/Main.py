#PATCHES: UPDATED ICONS, ADJUSTED NAVIGATION BAR, LITHIT PAGE CREATED. 
#LACKING FEATURES: NAV BAR UNCOMPLETED, LITHIT NOT SCROLLABLE.
...
def log_in_clock():
    ...
    login_clock_label.configure(text=hr_min_time, font=("Quando", 128))
...
sign_in_icon_stack_label_img = customtkinter.CTkImage(Image.open('icons\logo.png'),size=(465,65))
...
sign_in_icon_quote_label.place(x=645,y=180)
...
login_icon_stack_label_img = customtkinter.CTkImage(Image.open('icons\logo.png'),size=(465,65))
...
home_top_shelf_frame_outer = customtkinter.CTkFrame(home_frame,width=750,height=150,fg_color="#606060",corner_radius=45)
home_top_shelf_frame_outer.place(x = 270, y = 100)

home_top_shelf_frame_inner = customtkinter.CTkFrame(home_top_shelf_frame_outer,width=400,height=150,fg_color="#B88B68",corner_radius=45)
home_top_shelf_frame_inner.place(x = 170, y = 100)
...
addbooks_synopsis_frame = customtkinter.CTkFrame(add_books_frame,width=1015,height=450,fg_color="#808080",corner_radius=30)
addbooks_synopsis_frame.place(x=190,y=445)

addbooks_synopsis_frame_label = customtkinter.CTkLabel(addbooks_synopsis_frame,anchor="w",text="Synopsis",width=1015,height=75,fg_color="transparent",corner_radius=30,text_color="white",font=("Quando",35))
addbooks_synopsis_frame_label.place(x=20,y=0)

addbooks_synopsis_textbox = customtkinter.CTkTextbox(addbooks_synopsis_frame,width=1015,height=235,fg_color="#D9D9D9",corner_radius=30,font=("Quando",25))
...
button_stackread = customtkinter.CTkButton(icon_frame,image=button_stackread_img,text="",width=75,height=75,command=side_panel_switch,corner_radius=0,fg_color="#C8DF8C",hover_color="#737373")
